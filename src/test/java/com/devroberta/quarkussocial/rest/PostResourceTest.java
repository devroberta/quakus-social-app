...
class PostResourceTest {
    ...
    public void savePostTest(){
        ...
        postRequest.setText("Some Text Test");
    ...
    @Test
    @DisplayName("should return 404 when trying to make a post for a inexistent userr")
    ...
    @Test
    @DisplayName("should return 403 when follower doesn't follower")
